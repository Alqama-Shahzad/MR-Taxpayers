...
const translations = {
  en: {
    ...
    'services.audit.title': 'Accounting Service',
    'services.audit.desc': 'Professional accounting and bookkeeping services for businesses and individuals.',
    'services.importexport.title': 'Import Export',
    'services.importexport.desc': 'Complete import/export documentation, customs clearance, and trade compliance services.',
  ...
  ur: {
    ...
    'services.audit.title': 'اکاؤنٹنگ سروس',
    'services.audit.desc': 'کاروبار اور افراد کے لیے پیشہ ورانہ اکاؤنٹنگ اور بک کیپنگ خدمات۔',
    'services.importexport.title': 'امپورٹ ایکسپورٹ',
    'services.importexport.desc': 'مکمل امپورٹ/ایکسپورٹ دستاویزات، کسٹمز کلیئرنس، اور تجارتی کمپلائنس خدمات۔',
